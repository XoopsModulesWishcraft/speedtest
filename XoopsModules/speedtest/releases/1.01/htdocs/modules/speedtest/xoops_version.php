...
$modversion['releasedate'] = "Saturday: November 1, 2011";
...
$modversion['config'][$i]['formtype'] = 'text';
$modversion['config'][$i]['valuetype'] = 'text';
$modversion['config'][$i]['default'] = XOOPS_URL.'/modules/speedtest/cgi-bin/upload.cgi';
$modversion['config'][$i]['options'] = array();
...
$i++;
$modversion['config'][$i]['name'] = 'database_enabled';
