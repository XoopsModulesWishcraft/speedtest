<?php
	...
	// Admin Menu
	define('_MI_SPEEDTEST_TITLE_ADMENU1','Results');
	define('_MI_SPEEDTEST_ICON_ADMENU1','images/icons/admin/results.png');
	define('_MI_SPEEDTEST_LINK_ADMENU1','admin/index.php?op=results&fct=results');
